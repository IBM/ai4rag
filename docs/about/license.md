...
Contributors must sign off their commits using the [Developer Certificate of Origin (DCO)](https://developercertificate.org/).
...
For the complete Apache License 2.0 text, visit:
[https://www.apache.org/licenses/LICENSE-2.0](https://www.apache.org/licenses/LICENSE-2.0)

Or see the [LICENSE file](https://github.com/IBM/ai4rag/blob/main/LICENSE) in the repository.
